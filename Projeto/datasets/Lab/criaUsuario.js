...
function callService(fields, constraints, sortFields) {
	var serviceData = data(); /* Chamando o data() de serviceData para chamar o Dataset lá na frente */
	var params = serviceData.inputValues; /* Chama data(), o campo de inputValues, que se encontra no Dataset */
	var assigns = serviceData.inputAssignments; /* Novamente chama data(), no campo de inputAssignments, que é onde o usuário pode colocar os inputs */
	...
	for (var i in constraints) {
		if(constraints[i]['fieldName'] == "colleagueId") {
			params.colleagues[0].colleagueId = constraints[i]['finalValue'];  /* Acessando o nome do usuário na lista do colleagues, buscando o campo "colleagueId" */
		}
	...
	// Puxa os valores da Array de constraints que foi criada no CriaUser.js
