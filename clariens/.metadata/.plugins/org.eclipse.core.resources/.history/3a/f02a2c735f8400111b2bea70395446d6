...
function visaoAnalisarSolicitacao() {
  if (currentTask == 7) {
    ...
    // controle de visibilidade dos agrupadores
...
// Função para controlar a visibilidade do Conta contábil - Evento de Folha

function controlarVisibilidadeEventoFolha() {
    var departamento = normalizarTextoValidacao($("#zoomDepartamento").val());
    var tipoServico = normalizarTextoValidacao($("#tipoServico").val());
